...
export default defineConfig({
  ...
  mcp: {
    ...
    sources: [
      ...
      McpSource.github({ name: 'tips.sh', repo: 'tempoxyz/tempo', paths: ['tips'] }),
      McpSource.github({ repo: 'paradigmxyz/reth' }),
      McpSource.github({ repo: 'foundry-rs/foundry' }),
      McpSource.github({
        repo: 'foundry-rs/foundry-toolchain',
        branch: 'master',
        paths: ['.github', 'dist', 'src'],
      }),
      McpSource.github({ repo: 'wevm/viem' }),
      McpSource.github({ repo: 'wevm/wagmi' }),
      McpSource.github({ repo: 'wevm/ox' }),
      McpSource.github({ repo: 'wevm/mppx' }),
      McpSource.github({ repo: 'wevm/prool' }),
      McpSource.github({ repo: 'tempoxyz/tempo-ts' }),
      McpSource.github({ repo: 'tempoxyz/tempo-go', paths: ['pkg', 'examples'] }),
      McpSource.github({ repo: 'tempoxyz/pytempo', paths: ['src', 'examples'] }),
      McpSource.github({ repo: 'tempoxyz/tempo-std', branch: 'master' }),
      McpSource.github({ repo: 'tempoxyz/accounts', paths: ['src', 'examples', 'docs'] }),
      McpSource.github({ repo: 'tempoxyz/mpp', paths: ['src', 'docs'] }),
      McpSource.github({ repo: 'tempoxyz/mpp-rs' }),
      McpSource.github({ repo: 'tempoxyz/pympp', paths: ['src', 'examples'] }),
      McpSource.github({ repo: 'tempoxyz/tidx', paths: ['src', 'crates', 'docs'] }),
      McpSource.github({ repo: 'tempoxyz/zones', paths: ['crates', 'docs', 'specs'] }),
      McpSource.github({ repo: 'tempoxyz/wallet', paths: ['src', 'docs'] }),
      McpSource.github({
        repo: 'tempoxyz/tempo-apps',
        paths: ['apps/key-manager', 'apps/tokenlist', 'packages'],
      }),
    ],
  },
