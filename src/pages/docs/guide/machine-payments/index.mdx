...
- **Lower repeated channel lifecycle costs** — The planned T7 upgrade adds payer-scoped storage credits for MPP payment channels, helping repeated session lifecycles reuse channel-state savings
