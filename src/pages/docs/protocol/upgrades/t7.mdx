...
| MPP sessions can get cheaper over repeated channel lifecycles | Payment-channel credits stay scoped to the payer who closed or withdrew a channel, then can be reused when that payer opens a later channel. |
